...
- (void)confirm:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(VPImageCropperDelegate)]) {
        ...
        UIImage *sourceImage = [self getSubImage];
        
        UIImage *thumbImage = [self thumbnailWithImage:sourceImage size:CGSizeMake(THUMB_NAIL_SIZE, THUMB_NAIL_SIZE)];
        
        [self.delegate imageCropper:self didFinishedWithSource:sourceImage withThumbnailImage:thumbImage];
    }
}
